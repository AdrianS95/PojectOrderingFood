...
namespace NVC_Food_APP.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //public ManageController(JedzenieDbContext context)
        //{
        //    this.db = context;
        //}
        ...
        private ApplicationUserManager _userMaenager;
        public ApplicationUserManager _UserMenager
        {
            get
            {
                return _userMaenager ?? HttpContext.GetOwinContext().GetUserManager<ApplicationUserManager>();
            }
            set
            {
                _userMaenager = value;
        ...
        public ActionResult ListaZamowien()
        {
            ...
            if (isAdmin)
            {
                zamowieniaUzytkownika = db.Zamowienia.Include("PozycjaZamowienia").OrderByDescending(o => o.DataDowania).ToArray();
            }
            else
            {
                var userId = User.Identity.GetUserId();
                zamowieniaUzytkownika = db.Zamowienia.Where(o => o.UserId == userId).Include("PozycjaZamowienia").OrderByDescending(o => o.DataDowania).ToArray();
            }

            return View(zamowieniaUzytkownika);
        }

        //public ManageController(JedzenieDbContext context, IMailService mailService)
        //{
        //    this.db = context;
